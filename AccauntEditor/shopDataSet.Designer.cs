...
namespace AccauntEditor {
    ...
    public partial class shopDataSet : global::System.Data.DataSet {
        ...
        public partial class AccountsDataTable : global::System.Data.TypedTableBase<AccountsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public AccountsRow AddAccountsRow(string Login, string Pass, string Firstname, string Lastname, string PhoneNumber, string Email, string City) {
...
namespace AccauntEditor.shopDataSetTableAdapters {
    ...
    public partial class AccountsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM `Accounts` WHERE ((`ID` = ?) AND ((? = 1 AND `Login` IS NULL) OR (`Login` = ?)) AND ((? = 1 AND `Pass` IS NULL) OR (`Pass` = ?)) AND ((? = 1 AND `Firstname` IS NULL) OR (`Firstname` = ?)) AND ((? = 1 AND `Lastname` IS NULL) OR (`Lastname` = ?)) AND ((? = 1 AND `PhoneNumber` IS NULL) OR (`PhoneNumber` = ?)) AND ((? = 1 AND `Email` IS NULL) OR (`Email` = ?)) AND ((? = 1 AND `City` IS NULL) OR (`City` = ?)))";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::AccauntEditor.Properties.Settings.Default.shopConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ID, Login, Pass, Firstname, Lastname, PhoneNumber, Email, City FROM Accoun" +
                "ts";
        ...
        public virtual int Delete(int Original_ID, string Original_Login, string Original_Pass, string Original_Firstname, string Original_Lastname, string Original_PhoneNumber, string Original_Email, string Original_City) {
        ...
        public virtual int Insert(string Login, string Pass, string Firstname, string Lastname, string PhoneNumber, string Email, string City) {
            if ((Login == null)) {
        ...
        public virtual int Update(string Login, string Pass, string Firstname, string Lastname, string PhoneNumber, string Email, string City, int Original_ID, string Original_Login, string Original_Pass, string Original_Firstname, string Original_Lastname, string Original_PhoneNumber, string Original_Email, string Original_City) {
            if ((Login == null)) {
